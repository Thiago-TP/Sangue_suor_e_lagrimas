...
LoopVerificaCliquePersonagem:
	...
	li	t1, 5
	lw	t0, 16(a1)
	bge	t0, t1, PulaCliquePersonagem
...
PulaReiniciaMoveSet:
	...
	blt	t6, s4, LoopRetornaStandBy	# verifico se o contador eh diferente de s4 e se for volto pro Loop		
SaiReiniciaMoveSet:
...
PulaCliquePersonagem:
	...
	blt	t6, s4, LoopVerificaCliquePersonagem	# verifico se o contador eh diferente de s4 e se for volto pro Loop
	mv	t6, zero
LoopVerificaAliadoCursor:
	...
	li	t0, 6
	bge	t1, t0, PulaPersonagemCursor
	lw	t2, 0(a0)
	lw 	t3, 4(a0)
	lw 	t4, 0(a1)
	lw	t5, 4(a1)
...
PulaSetaMovimentacao:
	...
	blt	t6, s4, LoopVerificaMovimento	# verifico se o contador eh diferente de s4 e se for volto pro Loop
FimDecide:
